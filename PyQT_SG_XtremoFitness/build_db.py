...
import Utilerias.generico as gen  # Importamos un módulo personalizado para funcionalidades genéricas
...
engine = db.create_engine('sqlite:///bd/xtremo.sqlite', echo=True, future=True)
